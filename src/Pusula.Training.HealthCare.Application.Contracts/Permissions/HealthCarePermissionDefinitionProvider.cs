...
public class HealthCarePermissionDefinitionProvider : PermissionDefinitionProvider
{
    public override void Define(IPermissionDefinitionContext context)
    {
        ...
        var notePermission = myGroup.AddPermission(HealthCarePermissions.Notes.Default, L("Permission:Notes"));
        notePermission.AddChild(HealthCarePermissions.Notes.Create, L("Permission:Create"));
        ...
        var appintmentRulePermission = myGroup.AddPermission(HealthCarePermissions.AppointmentRules.Default, L("Permission:AppointmentRules"));
        appintmentRulePermission.AddChild(HealthCarePermissions.AppointmentRules.Create, L("Permission:Create"));
