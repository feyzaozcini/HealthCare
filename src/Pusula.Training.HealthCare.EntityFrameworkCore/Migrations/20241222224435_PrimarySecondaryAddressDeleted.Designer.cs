...
namespace Pusula.Training.HealthCare.Migrations
{
    ...
    [Migration("20241222224435_PrimarySecondaryAddressDeleted")]
    partial class PrimarySecondaryAddressDeleted
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.Anamneses.Anamnesis", b =>
                {
                    ...
                    b.ToTable("AppAnamneses", (string)null);
                });

            modelBuilder.Entity("Pusula.Training.HealthCare.AppointmentRules.AppointmentRule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppAppointmentRules", (string)null);
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.BlackLists.BlackList", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppBlackLists", (string)null);
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.DepartmentServices.DepartmentService", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppDepartmentServices", (string)null);
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.DiagnosisGroups.DiagnosisGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppDiagnosisGroups", (string)null);
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.DoctorAppoinmentTypes.DoctorAppoinmentType", b =>
                {
                    b.Property<Guid>("DoctorId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("AppoinmentTypeId")
                        .HasColumnType("uuid");

                    b.HasKey("DoctorId", "AppoinmentTypeId");

                    b.HasIndex("AppoinmentTypeId");

                    b.ToTable("AppDoctorAppoinmentTypes", (string)null);
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.ExaminationDiagnoses.ExaminationDiagnosis", b =>
                {
                    ...
                    b.ToTable("AppExaminationDiagnoses", (string)null);
                });

            modelBuilder.Entity("Pusula.Training.HealthCare.FallRisks.FallRisk", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("GeneralHealthState")
                        .HasColumnType("boolean")
                        .HasColumnName("GeneralHealthState");

                    b.Property<bool>("HasAddiction")
                        .HasColumnType("boolean")
                        .HasColumnName("HasAddiction");

                    b.Property<bool>("HasBalanceDisorder")
                        .HasColumnType("boolean")
                        .HasColumnName("HasBalanceDisorder");

                    b.Property<bool>("HasFallHistory")
                        .HasColumnType("boolean")
                        .HasColumnName("HasFallHistory");

                    b.Property<bool>("HasVisionImpairment")
                        .HasColumnType("boolean")
                        .HasColumnName("HasVisionImpairment");
                    ...
                    b.Property<bool>("UsesMedications")
                        .HasColumnType("boolean")
                        .HasColumnName("UsesMedications");
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.FollowUpPlans.FollowUpPlan", b =>
                {
                    ...
                    b.Property<bool>("IsSurgeryScheduled")
                        .HasColumnType("boolean")
                        .HasColumnName("IsSurgeryScheduled");
                    ...
                    b.ToTable("AppFollowUpPlans", (string)null);
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.Notes.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.PainDetails.PainDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("OtherPain")
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasColumnName("OtherPain");

                    b.Property<int>("PainRhythm")
                        .HasColumnType("integer")
                        .HasColumnName("PainRhythm");

                    b.Property<Guid>("PainTypeId")
                        .HasColumnType("uuid")
                        .HasColumnName("PainTypeId");
                    ...
                    b.ToTable("AppPainDetails", (string)null);
                });

            modelBuilder.Entity("Pusula.Training.HealthCare.PainTypes.PainType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppPainTypes", (string)null);
                });

            modelBuilder.Entity("Pusula.Training.HealthCare.PatientCompanies.PatientCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.PhysicalExaminations.PhysicalExamination", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppPhysicalExaminations", (string)null);
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.PshychologicalStates.PshychologicalState", b =>
                {
                    ...
                    b.ToTable("AppPshychologicalStates", (string)null);
                });

            modelBuilder.Entity("Pusula.Training.HealthCare.SystemChecks.SystemCheck", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<bool?>("Circulatory")
                        .HasColumnType("boolean")
                        .HasColumnName("Circulatory");
                    ...
                    b.Property<bool?>("GeneralSystemCheck")
                        .IsRequired()
                        .HasColumnType("boolean")
                        .HasColumnName("GeneralSystemCheck");

                    b.Property<bool?>("GenitoUrinary")
                        .HasColumnType("boolean")
                        .HasColumnName("GenitoUrinary");
                    ...
                    b.Property<bool?>("MusculoSkeletal")
                        .HasColumnType("boolean")
                        .HasColumnName("MusculoSkeletal");

                    b.Property<bool?>("Nervous")
                        .HasColumnType("boolean")
                        .HasColumnName("Nervous");
                    ...
                    b.ToTable("AppSystemChecks", (string)null);
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.TestGroupItems.TestGroupItem", b =>
                {
                    ...
                    b.ToTable("AppTestGroupItems", (string)null);
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.Anamneses.Anamnesis", b =>
                {
                    b.HasOne("Pusula.Training.HealthCare.Protocols.Protocol", null)
                        .WithOne()
                        .HasForeignKey("Pusula.Training.HealthCare.Anamneses.Anamnesis", "ProtocolId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.DoctorAppoinmentTypes.DoctorAppoinmentType", b =>
                {
                    b.HasOne("Pusula.Training.HealthCare.AppointmentTypes.AppointmentType", "AppoinmentType")
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.ExaminationDiagnoses.ExaminationDiagnosis", b =>
                {
                    b.HasOne("Pusula.Training.HealthCare.Diagnoses.Diagnosis", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.FallRisks.FallRisk", b =>
                {
                    b.HasOne("Pusula.Training.HealthCare.Protocols.Protocol", null)
                        .WithOne()
                        .HasForeignKey("Pusula.Training.HealthCare.FallRisks.FallRisk", "ProtocolId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.FollowUpPlans.FollowUpPlan", b =>
                {
                    b.HasOne("Pusula.Training.HealthCare.Protocols.Protocol", "Protocol")
                        .WithOne()
                        .HasForeignKey("Pusula.Training.HealthCare.FollowUpPlans.FollowUpPlan", "ProtocolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.PainDetails.PainDetail", b =>
                {
                    b.HasOne("Pusula.Training.HealthCare.PainTypes.PainType", "PainType")
                        .WithMany()
                    ...
                    b.HasOne("Pusula.Training.HealthCare.Protocols.Protocol", "Protocol")
                        .WithOne()
                        .HasForeignKey("Pusula.Training.HealthCare.PainDetails.PainDetail", "ProtocolId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.PhysicalExaminations.PhysicalExamination", b =>
                {
                    b.HasOne("Pusula.Training.HealthCare.Protocols.Protocol", null)
                        .WithOne()
                        .HasForeignKey("Pusula.Training.HealthCare.PhysicalExaminations.PhysicalExamination", "ProtocolId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.PshychologicalStates.PshychologicalState", b =>
                {
                    b.HasOne("Pusula.Training.HealthCare.Protocols.Protocol", null)
                        .WithOne()
                        .HasForeignKey("Pusula.Training.HealthCare.PshychologicalStates.PshychologicalState", "ProtocolId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.SystemChecks.SystemCheck", b =>
                {
                    b.HasOne("Pusula.Training.HealthCare.Protocols.Protocol", "Protocol")
                        .WithOne()
                        .HasForeignKey("Pusula.Training.HealthCare.SystemChecks.SystemCheck", "ProtocolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pusula.Training.HealthCare.TestValueRanges.TestValueRange", b =>
                {
                    b.HasOne("Pusula.Training.HealthCare.TestGroupItems.TestGroupItem", "TestGroupItem")
                        .WithOne("TestValueRange")
                        .HasForeignKey("Pusula.Training.HealthCare.TestValueRanges.TestValueRange", "TestGroupItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
