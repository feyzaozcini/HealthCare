...
namespace Pusula.Training.HealthCare.TestProcesses
{
    public interface ITestProcessRepository : IRepository<TestProcess, Guid>
    {
        ...
        Task<TestProcessWithNavigationProperties> GetWithNavigationPropertiesAsync(
            Guid id,
            CancellationToken cancellationToken = default);

        Task<List<TestProcessWithNavigationProperties>> GetListWithNavigationPropertiesAsync(
            string? filterText = null,
            TestProcessStates? status = null,
            decimal? result = null,
            DateTime? resultDate = null,
        ...
        Task<List<TestProcessWithNavigationProperties>> GetByLabRequestIdAsync(
            Guid labRequestId,
            CancellationToken cancellationToken = default);
    }
}
